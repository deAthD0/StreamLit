...
Industry_type_Selected_Data_Frame=naukri_df.loc[naukri_df['Industry_Type'] == "ITES, BPO, KPO, LPO, Customer Service, Operations"]

sector_graph(Industry_type_Selected_Data_Frame, df)
Industry_type_graph(Industry_type_Selected_Data_Frame, df)
Role_Category_Graph(Industry_type_Selected_Data_Frame,df)
Employment_Type_graph(Industry_type_Selected_Data_Frame,df)
Functional_area_graph(Industry_type_Selected_Data_Frame, df)
