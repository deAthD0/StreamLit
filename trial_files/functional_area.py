...
functional_Selected_Data_Frame=naukri_df.loc[naukri_df['Functional_Area'] == "ITES, BPO, KPO, LPO, Customer Service, Operations"]

sector_graph(functional_Selected_Data_Frame, df)
Industry_type_graph(functional_Selected_Data_Frame, df)
Role_Category_Graph(functional_Selected_Data_Frame,df)
Employment_Type_graph(functional_Selected_Data_Frame,df)
Functional_area_graph(functional_Selected_Data_Frame, df)
