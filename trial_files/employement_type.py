...
def employmentType():
    ...
    employement_Selected_Data_Frame=naukri_df.loc[naukri_df['Employment_Type'] == "Full Time, Permanent"]

    sector_graph(employement_Selected_Data_Frame, df)
    Industry_type_graph(employement_Selected_Data_Frame, df)
    Role_Category_Graph(employement_Selected_Data_Frame,df)
    Employment_Type_graph(employement_Selected_Data_Frame,df)
    Functional_area_graph(employement_Selected_Data_Frame, df)
